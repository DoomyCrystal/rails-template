...
hyperform.addTranslation("de",{
  ...
  TextTooShort:"Bitte verwenden Sie mindestens %l Zeichen (Sie verwenden derzeit %l Zeichen).",
  ValueMissing:"Bitte füllen Sie dieses Feld aus.",
  CheckboxMissing:"Bitte klicken Sie dieses Kästchen an, wenn Sie fortfahren möchten.",
